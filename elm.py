...
class ExtremeLM:
    ...
    def __init__(self,**kwargs):
        ...
        attr_list = set(['train_path','train_label','train_feature','test_path','test_label',
                         'test_feature','train_label_rs','test_label_rs','rlags','elm_data',
                         'col_names','file_path'])
    ...
    def elm_model(self):
        ...
        # self.train_feature = self.train_feature.drop(columns = ['area','time','Unnamed: 0', 'level_0', 'Unnamed: 0.1', 'index'])
        self.train_feature = self.train_feature[self.train_feature['date'] != '2016-01-01']
        # self.test_feature = self.test_feature.drop(columns = ['area','time','Unnamed: 0', 'level_0', 'Unnamed: 0.1', 'index'])
...
if __name__ == "__main__":
    ...
    file_path =  '/home/congnitensor/Python_projects/ptc_armax/ptc_elm_pred/ptc_elm_pred_e1_volume.csv'
